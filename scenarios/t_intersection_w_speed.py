...
scenario = Scenario('west_coast_usa', 't_intersection_w_speed')
...
for _ in range(240):
    ...
    if dist_car_2_next > dist_car_2_prev:
        ...
        if sensors['electrics']['values']['wheelspeed'] == 40 or dmg['damage'] == 0:
            print('[Successful] VUT is moving at 40 kmph')
        else:
            print('[Failed] VUT did not move at 40 kmph or it is damaged')
